...
m.mentionedJid = m.msg?.contextInfo?.mentionedJid || [];
        ...
        if (m.quoted) {
            ...
            m.quoted.fromMe = m.quoted.sender === (socket.user && socket.user.id)
  ...
  m.text = (
     ...
     */
    m.reply = (text, chatId = m.chat, options = {}) => Buffer.isBuffer(text) ? socket.sendMedia(chatId, text, 'file', '', m, {
        ...options
    }) : socket.sendText(chatId, text, m, {
        ...options
    })
    /**
     * Copy this message
